...
// Team 302 includes
#include <SoftwareTestShooter.h>            // This class'
...
//----------------------------------------------------------------------------------
// Method:      SoftwareTestShooter <<Constructor>>
// Description: Create the motor controllers and set whether they are inverted or not.
//----------------------------------------------------------------------------------
SoftwareTestShooter::SoftwareTestShooter() : IShooter(),
                                             ...
                                             m_shooterAlign( nullptr )
{
    ...
    // Shooter Alignment
    m_shooterAlign   = new CANTalon( SHOOTER_ALIGN_MOTOR );                         // create object
    ...
    // Shooter wheels
    m_shooterWheel  = new CANTalon( SHOOTER_WHEEL_MOTOR );                          // create object
    ...
    // Shooter Loader
    m_shooterLoader = new CANTalon( SHOOTER_LOAD_MOTOR );                           // create object
...
// Returns:     void
//----------------------------------------------------------------------------------
void SoftwareTestShooter::SetShooterSpeed
(
...
// Returns:     void
//----------------------------------------------------------------------------------
void SoftwareTestShooter::SetBallLoadMotor
(
...
//----------------------------------------------------------------------------------
bool SoftwareTestShooter::IsLoaderInPosition() const
{
...
// Returns:     void
//----------------------------------------------------------------------------------
void SoftwareTestShooter::AlignShooter
(
    const float speed   // <I> - Speed for the shooter wheel (range -1.0 to 1.0)
) const
{
...
//----------------------------------------------------------------------------------
bool SoftwareTestShooter::IsShooterAtLeftBound() const
{
    return false;
}
...
//                          false = not in at bound position
//----------------------------------------------------------------------------------
bool SoftwareTestShooter::IsShooterAtRightBound() const
{
    return false;
}

//----------------------------------------------------------------------------------
// Method:      ~SoftwareTestShooter <<Destructor>>
// Description: Delete the motor controllers
//----------------------------------------------------------------------------------
SoftwareTestShooter::~SoftwareTestShooter()
{
